import{u as r,j as s}from"./index-Dlxm52NL.js";const a={title:"Gasless Transactions on Base using Base Paymaster",description:"undefined"};function i(n){const e={a:"a",blockquote:"blockquote",br:"br",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...r(),...n.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.header,{children:s.jsxs(e.h1,{id:"gasless-transactions-on-base-using-base-paymaster",children:["Gasless Transactions on Base using Base Paymaster",s.jsx(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#gasless-transactions-on-base-using-base-paymaster",children:s.jsx(e.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(e.p,{children:"Still trying to onboard users to your app? Want to break free from the worries of gas transactions and sponsor them for your users on Base? Look no further!"}),`
`,s.jsxs(e.p,{children:["Base transaction fees are typically less than a penny, but the concept of gas can still be confusing for new users. You can abstract this away and improve your UX by using the ",s.jsx(e.strong,{children:"Base Paymaster"}),". The Paymaster allows you to:"]}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsx(e.li,{children:"Batch multi-step transactions"}),`
`,s.jsx(e.li,{children:"Create custom gasless experiences"}),`
`,s.jsx(e.li,{children:"Sponsor up to $10k monthly on mainnet (unlimited on testnet)"}),`
`]}),`
`,s.jsxs(e.blockquote,{children:[`
`,s.jsxs(e.p,{children:[s.jsx(e.strong,{children:"Note:"})," If you need an increase in your sponsorship limit, please ",s.jsx(e.a,{href:"https://discord.com/invite/cdp",children:"reach out on Discord"}),"!"]}),`
`]}),`
...
`]}),`
`,s.jsxs(e.blockquote,{children:[`
`,s.jsxs(e.p,{children:[s.jsx(e.strong,{children:"Testnet vs. Mainnet"}),s.jsx(e.br,{}),`
`,"If you prefer not to spend real funds, you can switch to ",s.jsx(e.strong,{children:"Base Goerli"})," (testnet). The steps below are conceptually the same. Just select ",s.jsx(e.em,{children:"Base Goerli"})," in the Coinbase Developer Platform instead of ",s.jsx(e.em,{children:"Base Mainnet"}),", and use a contract deployed on Base testnet for your allowlisted methods."]}),`
`]}),`
...
`,s.jsxs(e.ol,{children:[`
`,s.jsxs(e.li,{children:["From the Configuration page, ensure ",s.jsx(e.strong,{children:"Base Mainnet"})," (or ",s.jsx(e.strong,{children:"Base Goerli"})," if you’re testing) is selected."]}),`
...
`,s.jsxs(e.blockquote,{children:[`
`,s.jsxs(e.p,{children:[s.jsx(e.strong,{children:"Use your own contract"}),s.jsx(e.br,{}),`
...
`,s.jsxs(e.blockquote,{children:[`
`,s.jsxs(e.p,{children:[s.jsx(e.strong,{children:"Limit Cycles"}),s.jsx(e.br,{}),`
...
`,s.jsxs(e.ol,{children:[`
`,s.jsxs(e.li,{children:["Ensure you have ",s.jsx(e.strong,{children:"Rust"})," installed. If not:",`
`,s.jsx(s.Fragment,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark",style:{backgroundColor:"#fff","--shiki-dark-bg":"#24292e",color:"#24292e","--shiki-dark":"#e1e4e8"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:s.jsx(e.code,{children:s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#B392F0"},children:"curl"}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#79B8FF"},children:" --proto"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#9ECBFF"},children:" '=https'"}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#79B8FF"},children:" --tlsv1.2"}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#79B8FF"},children:" -sSf"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#9ECBFF"},children:" https://sh.rustup.rs"}),s.jsx(e.span,{style:{color:"#D73A49","--shiki-dark":"#F97583"},children:" |"}),s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#B392F0"},children:" sh"})]})})})}),`
`]}),`
`,s.jsxs(e.li,{children:["Install Foundry:",`
`,s.jsx(s.Fragment,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark",style:{backgroundColor:"#fff","--shiki-dark-bg":"#24292e",color:"#24292e","--shiki-dark":"#e1e4e8"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:s.jsxs(e.code,{children:[s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#B392F0"},children:"curl"}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#79B8FF"},children:" -L"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#9ECBFF"},children:" https://foundry.paradigm.xyz"}),s.jsx(e.span,{style:{color:"#D73A49","--shiki-dark":"#F97583"},children:" |"}),s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#B392F0"},children:" bash"})]}),`
...
`,s.jsx(s.Fragment,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark",style:{backgroundColor:"#fff","--shiki-dark-bg":"#24292e",color:"#24292e","--shiki-dark":"#e1e4e8"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:s.jsx(e.code,{children:s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#B392F0"},children:"cast"}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#79B8FF"},children:" --help"})]})})})}),`
...
`,s.jsxs(e.ol,{children:[`
`,s.jsxs(e.li,{children:["Make a new folder and install dependencies:",`
`,s.jsx(s.Fragment,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark",style:{backgroundColor:"#fff","--shiki-dark-bg":"#24292e",color:"#24292e","--shiki-dark":"#e1e4e8"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:s.jsxs(e.code,{children:[s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#B392F0"},children:"mkdir"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#9ECBFF"},children:" sponsored_transactions"})]}),`
...
`,s.jsx(s.Fragment,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark",style:{backgroundColor:"#fff","--shiki-dark-bg":"#24292e",color:"#24292e","--shiki-dark":"#e1e4e8"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:s.jsxs(e.code,{children:[s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#B392F0"},children:"cast"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#9ECBFF"},children:" wallet"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#9ECBFF"},children:" new"})]}),`
...
`,s.jsx(s.Fragment,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark",style:{backgroundColor:"#fff","--shiki-dark-bg":"#24292e",color:"#24292e","--shiki-dark":"#e1e4e8"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:s.jsxs(e.code,{children:[s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#B392F0"},children:"Successfully"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#9ECBFF"},children:" created"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#9ECBFF"},children:" new"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#9ECBFF"},children:" keypair."})]}),`
...
`,s.jsx(e.strong,{children:"Store these private keys somewhere safe"})," — ideally in a ",s.jsx(e.code,{children:".env"})," file."]}),`
`]}),`
...
`,s.jsx(e.strong,{children:"Never"})," commit ",s.jsx(e.code,{children:".env"})," files to a public repo!"]}),`
`]}),`
`,s.jsxs(e.h2,{id:"example-indexjs-using-twoslash",children:["Example ",s.jsx(e.code,{children:"index.js"})," (Using Twoslash)",s.jsx(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#example-indexjs-using-twoslash",children:s.jsx(e.div,{"data-autolink-icon":!0})})]}),`
`,s.jsxs(e.p,{children:["Below is a full example of how you might structure ",s.jsx(e.code,{children:"index.js"}),".",s.jsx(e.br,{}),`
`,"We’ll use ",s.jsx(e.strong,{children:"twoslash"})," code blocks (````js twoslash`) to highlight key lines and explanations."]}),`
...
`,s.jsx(e.span,{className:"line",children:s.jsx(e.span,{style:{color:"#24292E","--shiki-dark":"#E1E4E8"},children:"})();"})})]})})}),`
`,s.jsxs(e.blockquote,{children:[`
`,s.jsxs(e.p,{children:[s.jsx(e.strong,{children:"Note"}),":"]}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:["Run this via ",s.jsx(e.code,{children:"node index.js"})," from your project root."]}),`
`,s.jsx(e.li,{children:"If your Paymaster settings are strict (e.g., limit 1 transaction per user), the second time you run the script, you may get a “request denied” error, indicating the policy is working."}),`
`]}),`
`]}),`
