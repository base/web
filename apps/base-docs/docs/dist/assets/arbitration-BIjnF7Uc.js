import{u as a,j as e}from"./index-Dlxm52NL.js";const o={title:"Arbitration",description:"SEQUENCER, TESTNET, AND BASENAMES INTERFACE TERMS ARBITRATION AGREEMENT"};function i(n){const t={a:"a",div:"div",h1:"h1",h3:"h3",header:"header",p:"p",strong:"strong",...a(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.header,{children:e.jsxs(t.h1,{id:"sequencer-testnet-and-basenames-interface-terms-arbitration-agreement",children:["SEQUENCER, TESTNET, AND BASENAMES INTERFACE TERMS ARBITRATION AGREEMENT",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#sequencer-testnet-and-basenames-interface-terms-arbitration-agreement",children:e.jsx(t.div,{"data-autolink-icon":!0})})]})}),`
`,e.jsxs(t.h3,{id:"1-applicability-of-arbitration-agreement",children:["1. Applicability of Arbitration Agreement",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#1-applicability-of-arbitration-agreement",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:`Subject to the terms of this Sequencer, Testnet, and Basenames Interface Terms
...
`,e.jsxs(t.h3,{id:"2-waiver-of-jury-trial",children:["2. Waiver of Jury Trial",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#2-waiver-of-jury-trial",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:`YOU AND COINBASE HEREBY WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO SUE IN
...
`,e.jsxs(t.h3,{id:"3-waiver-of-class-and-other-non-individualized-relief",children:["3. Waiver of Class and Other Non-Individualized Relief",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#3-waiver-of-class-and-other-non-individualized-relief",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:`YOU AND COINBASE AGREE THAT, EXCEPT AS SPECIFIED IN SECTION 8, EACH OF US MAY
...
`,e.jsxs(t.h3,{id:"4-rules-and-forum",children:["4. Rules and Forum",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#4-rules-and-forum",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(t.p,{children:[`The Base ToS evidences a transaction involving interstate commerce; and
...
Arbitration Association (`,e.jsx(t.strong,{children:"“AAA”"}),`), in accordance with the Consumer Arbitration
Rules (the `,e.jsx(t.strong,{children:'"AAA Rules"'}),`) then in effect, except as modified by this
Arbitration Agreement. The AAA Rules are currently available at `,e.jsx(t.a,{href:"https://www.adr.org/sites/default/files/Consumer%20Rules.pdf",children:"https://www.adr.org/sites/default/files/Consumer%20Rules.pdf"}),"."]}),`
`,e.jsxs(t.p,{children:[`A party who wishes to initiate arbitration must provide the other party with a
request for arbitration (the `,e.jsx(t.strong,{children:"“Request”"}),`). If you initiate the arbitration,
you must provide Coinbase a copy of your Request by email at [`,e.jsx(t.a,{href:"mailto:arbitration@coinbase.com",children:"arbitration@coinbase.com"}),`]
...
`,e.jsx(t.p,{children:`If the party requesting arbitration is represented by counsel, the Request shall
...
`,e.jsx(t.p,{children:`Unless you and Coinbase otherwise agree, or the Batch Arbitration process
...
`,e.jsx(t.p,{children:`You and Coinbase agree that all materials and documents exchanged during the
...
`,e.jsxs(t.h3,{id:"5-arbitrator",children:["5. Arbitrator",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#5-arbitrator",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:`The arbitrator will be either a retired judge or an attorney licensed to
...
`,e.jsxs(t.h3,{id:"6-authority-of-arbitrator",children:["6. Authority of Arbitrator",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#6-authority-of-arbitrator",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:`The arbitrator shall have exclusive authority to resolve any Dispute, including,
...
`,e.jsxs(t.h3,{id:"7-attorneys-fees-and-costs",children:["7. Attorneys' Fees and Costs",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#7-attorneys-fees-and-costs",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:`The parties shall bear their own attorneys' fees and costs in arbitration unless
...
`,e.jsxs(t.h3,{id:"8-batch-arbitration",children:["8. Batch Arbitration",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#8-batch-arbitration",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(t.p,{children:[`To increase the efficiency of administration and resolution of arbitrations, you
...
and one final award (`,e.jsx(t.strong,{children:"“Batch Arbitration”"}),")."]}),`
`,e.jsxs(t.p,{children:[`All parties agree that Requests are of a “substantially similar nature” if they
...
process (`,e.jsx(t.strong,{children:"“Administrative Arbitrator”"}),`). In an effort to expedite resolution
...
paid by Coinbase.`]}),`
`,e.jsx(t.p,{children:`You and Coinbase agree to cooperate in good faith with the AAA to implement the
...
proceedings.`}),`
`,e.jsx(t.p,{children:`This Batch Arbitration provision shall in no way be interpreted as authorizing a
...
`,e.jsxs(t.h3,{id:"9-modification",children:["9. Modification",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#9-modification",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:`If we make any updates to the Arbitration Agreement, we will make the updated
...
`,e.jsxs(t.h3,{id:"10-severability",children:["10. Severability",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#10-severability",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:`If any provision of this Arbitration Agreement shall be determined to be invalid
...
this Arbitration Agreement shall not be affected.`})]})}function s(n={}){const{wrapper:t}={...a(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{s as default,o as frontmatter};
