...
Follow the [guidance steps](https://docs.supra.com/oracles/dvrf/v2-guide#step-1-create-the-supra-router-contract-interface-2) provided by Supra for whitelisting your contract and depositing funds.
