...
onchain history with them as the earliest Base builders. Since the anniversary
of the Quest in 2024, holders of the testnet NFT have been able to claim
a commemorative NFT on Base mainnet.
