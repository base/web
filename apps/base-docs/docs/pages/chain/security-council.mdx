...
* [Entity] [Moonwell](https://moonwell.fi/) – signer based in Brazil
  * Moonwell is a decentralized lending and borrowing platform built on Base. 
  * 0x21C7D1e6A81Daca071bA94839ab74C39A25f851F 
* [Entity] [Blackbird](https://www.blackbird.xyz/) – signer based in USA
...
* [Entity] [ChainSafe](https://chainsafe.io/) – signer based in Canada
  * ChainSafe is a blockchain R&D firm focused on decentralized infrastructure.
  * 0x1C56A6d2A6Af643cea4E62e72B75B9bDe8d62e2B
* [Entity] [Talent Protocol](https://app.talentprotocol.com/) – signer based in Portugal
...
* [Entity] [Moshicam](https://moshi.cam/) – signer based in USA
...
* [Individual] [Roberto Bayardo](https://warpcast.com/bayardo.eth) – based in USA
