...
You can set your Basename as your primary name by updating this in Profile Management. If you set your Basename as your primary name, it will be displayed on any wallet or app that has added support for Basenames.
...
<Callout type="warning">
  **Do not send the Basename NFT on OpenSea**
</Callout>
