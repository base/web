...
- [Signing Offchain Messages using Wagmi/Viem](#signing-offchain-messages-using-wagmiviem)
  - [Prerequisites](#prerequisites)
  - [Signing a Simple Message](#signing-a-simple-message)
  - [Signing Typed Data (EIP-712)](#signing-typed-data-eip-712)
- [Handling Advanced Cases](#handling-advanced-cases)
  - [Onchain Signatures](#onchain-signatures)
...
:::info
If your implementation is more complicated and is not covered by the above assumptions, please refer to the "Handling Advanced Cases" section below.
:::
