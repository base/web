...
Once you've [created a Sub Account](/identity/smart-wallet/guides/linked-accounts/creating-sub-accounts), you can use it to perform various operations like signing messages and sending transactions. In this section, we'll cover how to interact with your Sub Account.
