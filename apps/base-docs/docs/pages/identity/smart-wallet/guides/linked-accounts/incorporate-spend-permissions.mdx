...
In the [previous steps](/identity/smart-wallet/guides/linked-accounts/using-sub-accounts) we learned how to create a sub account and send valueless transactions with it.
