...
To support using Coinbase Smart Wallet with user experiences that require more developer control over the wallet interactions, we've built Sub Accounts in conjunction with EIP-XXXX, a new wallet RPC for creating hierarchical relationships between wallet accounts.
