...
The demo above uses MiniKit, but the code is the same for OnchainKit.
...
You can now use Sub Accounts in your app.

## Next steps

- [Sub Accounts Intro Page](/identity/smart-wallet/guides/sub-accounts)
- [Sub Accounts API Reference](/identity/smart-wallet/technical-reference/sdk/sub-account-reference)
- Join the _#smart-wallet_ channel on [Discord](https://discord.gg/cdp) if you have any questions
