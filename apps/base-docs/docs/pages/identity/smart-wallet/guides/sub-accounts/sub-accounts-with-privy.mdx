...
In this guide, you'll learn how to enable [Smart Wallet Sub Accounts](/identity/smart-wallet/features/sub-accounts) in a [Privy](https://www.privy.io/) project. This allows your users to automatically create a sub account with spend limits when connecting their wallet via Privy.
...
- [Smart Wallet Sub Accounts](/identity/smart-wallet/features/sub-accounts) are **only available on the canary version** of the Coinbase Wallet SDK and on **Base Sepolia**
...
- [Smart Wallet Sub Accounts Feature](/identity/smart-wallet/features/sub-accounts)
