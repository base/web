...
:::info
Note: When planning architecture or making complex design decisions, use AI models with strong reasoning—like ChatGPT-4 Turbo or Claude 3.5 Sonnet. They excel at thinking through tradeoffs, edge cases, and long-term planning.
:::
