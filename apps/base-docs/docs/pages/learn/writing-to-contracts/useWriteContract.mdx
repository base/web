...
In this step-by-step, you're going to start with the [`useWriteContract`] hook. You probably won't want to use this method in production. In the next step-by-step, we'll show you the [`useSimulateContract`](https://github.com/base/web/blob/master/apps/base-docs/docs/pages/learn/writing-to-contracts/useSimulateContract.mdx) hook, how it works with `useWriteContract`, and how you can use it to create a better user experience.
