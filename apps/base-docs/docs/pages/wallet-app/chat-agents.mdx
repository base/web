...
This guide will walk you through creating, testing, and deploying your first XMTP agent. By the end, you'll have a fully functional agent that can send and receive messages on the XMTP network.
...
- [Faucets (CDP, thirdweb)](https://portal.cdp.coinbase.com/products/faucet)
