...
Base Sepolia full block RPC endpoint: https://sepolia.base.org
Base Sepolia flashblock RPC endpoint: https://sepolia-preconf.base.org

submit your build by replying to this tweet with the hashtag #baseflash

submissions are open for 24h until tomorrow Fri 2/28 2pm MT

submissions will be judged on clarity and creativity, by members of the @buildonbase chain team, Base DevRel team, and @flashbots team

winners will be announced tomorrow Fri 2/28 3pm MT at the Home Base booth and on socials — come through for free pizza and flashblocks demo
...
- **Deadline**: Submit by 2pm MNT on Friday 2/28
- **Submission**: Reply on [this X post](//tom's post url here) with your submissions
