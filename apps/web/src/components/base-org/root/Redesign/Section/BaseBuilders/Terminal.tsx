...
export function Terminal() {
  ...
  return (
    <motion.div
      className="h-auto min-h-[180px] w-fit min-w-[300px] max-w-[660px] overflow-hidden rounded-2xl border border-base-gray-25/20 bg-[#000000] font-mono md:min-h-[280px]"
      style={TERMINAL_STYLES.container}
      variants={itemContentVariants}
    >
      <div className="flex items-center justify-between gap-1 bg-[#262626] px-2 py-1">
        ...
        <div className="flex flex-1 justify-start">
          <div className="flex items-center text-xs text-white/40 md:text-sm">
            <span className="ml-2 font-sans font-medium">&gt; OnchainKit</span>
          </div>
        </div>
    ...
    >
      ...
      <defs>
        <clipPath id="innerStrokeClip">
          <rect x="0" y="0" rx="7" width="14" height="14" />
        </clipPath>
      </defs>
    </svg>
  );
